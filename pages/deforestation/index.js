...
class SemanticDeforestation extends React.Component {
    ...
    render() {
        ...
        const parsedBingNews = this.props.jsonNewsOp.value
        ...
        return (
            <>
                <SiteHeader description={deforestationMetaDescription}
                                    ...
                                    <Container id='deforestation-text' textAlign='left'>
                                        ...
                                        this.state.toggle ? (
                                            <p>
                                                ...
                                                <b>
                                                    deforestation alert system</b>
                                                that monitors forest
                                            ...
                                            <p>
                                                ...
                                                <a href='https://science.sciencemag.org/content/342/6160/850' target='_blank'>
                                                    source
                                                </a>
                                                (Hansen et al., Science 2013).{' '} </p>
                                        )
                                    } </Container>
                                </Grid.Row>
                            </Grid>
...
export async function getServerSideProps({res}) {
    ...
    const gNewsResp = await axios.get(`https://gnews.io/api/v3/search?q=%22deforestation%22&lang=en&image=required&token=${gNewsVariable}`);

    const gJson = JSON.parse(JSON.stringify(gNewsResp.data));
    // const gData = await gJson;
    const jsonNewsOp = JSON.parse(JSON.stringify(resp));
