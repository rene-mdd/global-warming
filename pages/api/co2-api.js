...
export default async (req, res) => { // "ftp://aftp.cmdl.noaa.gov/products/trends/co2/co2_trend_gl.txt"
    ...
    const {data, error} = await getFTPData(connectionConfig, 'products/trends/co2/co2_trend_gl.csv');
