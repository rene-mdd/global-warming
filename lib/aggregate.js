...
export function aggregate(records, { startTime, endTime }) {
  ...
  return {
    ...
    totals: {
      ...
      bytes,
      botRequests,
      // How many records carry a country at all. Only the 7 instrumented
      // public API routes populate this (see lib/log-request.js) — this is a
      // "how much of my traffic is instrumented" signal, not a data-quality
      // problem to fix.
      withCountry,
...
/**
 * "Which IPs are coming from where" — a country -> IP tree.
 *
